...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/course-syllabus/{courseid}', [DashboardController::class, 'LiveStreambyid'])->name('live.streamid');
...
Route::middleware(['auth', 'admin'])->prefix('admin')->group(function () {
    ...
    Route::get('/fetch-sub-topic/{syllabusId}', [DashboardController::class, 'fetchByTitle'])->name('fetch.subtitle');
