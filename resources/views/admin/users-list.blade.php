                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <form action="{{ route('searchUsers') }}" method="GET">
                                    <input type="text" name="search" class="form-control form-control-solid w-250px ps-13" placeholder="Search user" />
                                </form>
                            </div>
                            <!--end::Search-->
                        </div>
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                    ...
                                    <!--end::Separator-->
                                    <form method="GET" action="{{ route('filter.userlist') }}">
                                        <!--begin::Content-->
                                        <div class="px-7 py-5" data-kt-user-table-filter="form">
                                            <!--begin::Input group-->
                                            <div class="mb-10">
                                                <label class="form-label fs-6 fw-semibold">Payment Status:</label>
                                                <select class="form-select form-select-solid fw-bold" name="payment_status" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-user-table-filter="payment_status" data-hide-search="true">
                                                    <option></option>
                                ...
                                <!--begin::Export-->
                                <a type="button" href="{{ route('users.export') }}" class="btn btn-light-primary me-3">
                                ...
                                <form action="{{ route('users.import') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <!--begin::Import-->
                                    <label for="importFile" class="btn btn-light-primary me-3">
                                        <input type="file" name="file" id="importFile" style="display: none;">
                                        <i class="ki-duotone ki-exit-down fs-2"><span class="path1"></span><span class="path2"></span></i> Import
                                    </label>
                                    <!--end::Import-->
                                    <input type="submit" value="File Upload" class="btn btn-primary">
                                </form>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                ...
                                <tr>
                                    ...
                                    <td>
                                    @if (isset($courseDetails[$contact->id]))
                                    @if($courseDetails[$contact->id]['tuition_fee']>$contact->sub_amount && $contact->sub_amount!=NULL)
                                        <p>{{ $courseDetails[$contact->id]['tuition_fee']-$contact->sub_amount }}</p>
                                        @elseif($courseDetails[$contact->id]['tuition_fee']<=$contact->sub_amount || $contact->sub_amount==NULL)
                                        <p>Fully Paid</p>
                                        @endif
                                        @else
                                        <p>No course details found for this user.</p>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('userview', ['id' => $contact->id]) }}" class="menu-link px-3">
                                                    View
                                                </a>
                                            </div>
                                            <!--end::Menu item-->
                                            ...
                                            <div class="menu-item px-3">
                                                <form action="{{ route('users.destroy', ['id' => $contact->id]) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="menu-link px-3" onclick="return confirm('Are you sure you want to delete this user?')" style="background-color: transparent; border-color: transparent;">
                                                        Delete
                                                    </button>
                                                </form>
                                            </div>
