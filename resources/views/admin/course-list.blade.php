                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                    ...
                                    <div class="px-7 py-5" data-kt-user-table-filter="form">
                                        <!--begin::Input group-->
                                        <div class="mb-10">
                                            <label class="form-label fs-6 fw-semibold">Course Payment:</label>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            <thead>
                                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px">No of Registered Users</th>
                                    <th class="min-w-125px">No of Paid Users</th>
                                    <th class="min-w-125px">Instructors </th>
                                    <th class="min-w-125px">Tuition Fee</th>
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                ...
                                <tr>
                                   ...
                                   <td>
                                        ...
                                        <img src="{{ asset('storage/' .($course->profilePicture->path)) }}" height="50" width="50" alt="Course Logo">
                                        @endif
                                    </td>
                                    ...
                                    <td class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="view.html" class="text-gray-800 text-hover-primary mb-1">{{ $course->course_name }}</a>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('course.view', ['id' => $course->id]) }}" class="menu-link px-3">
                                                    View
                                                </a>
                                            ...
                                            <div class="menu-item px-3">
                                                ...
                                                <form action="{{ route('course.destroy', ['contact' => $course->id]) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
