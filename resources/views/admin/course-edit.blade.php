                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('course.update', ['id' => $courses->id])  }}" class="form mb-15" method="POST" id="kt_careers_form" enctype="multipart/form-data">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('../assets/media/svg/avatars/blank.svg')">
                                            ...
                                            @if ($courses->profilePicture)


                                            <div class="image-input-wrapper w-125px h-125px" style="background-image: url('{{ asset('storage/' . ($courses->profilePicture->path)) }}')">
                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        <!--begin::Label-->
                                        <label class="required fs-5 fw-semibold mb-2">Course Category</label>
                                        <!--end::Label-->

                                        <!--begin::Input-->
                                        <input class="form-control form-control-solid" type="text" placeholder="" value="{{ $courses->course_cat }}" name="course_cat" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Col-->
                                    <!--begin::Col-->
                                    <div class="col-md-6 fv-row">
                                        <!--begin::Label-->
                                        <label class="required fs-5 fw-semibold mb-2">Course Tags</label>
                                        <!--end::Label-->

                                        <!--begin::Input-->
                                        <input class="form-control form-control-solid" type="text" placeholder="" value="{{ $courses->course_tag }}" name="course_tag" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Col-->
                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col-md-12 fv-row">
                                        ...
                                        <textarea class="form-control form-control-solid" id="about_course" rows="2" name="about_course" placeholder="">{{ $courses->about_course }}</textarea>
                                    </div>
                                    <!--end::Col-->
                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col-md-12 fv-row">
                                        <!--begin::Label-->
                                        <label class="required fs-5 fw-semibold mb-2">Course Objectives</label>
                                        <!--end::Label-->

                                        <textarea class="form-control form-control-solid" rows="2" name="course_obj" placeholder="">{{$courses->course_obj}}</textarea>
                                    </div>
                                    <!--end::Col-->
                                ...
                                <!--end::Input group-->
                                 ...
                                 <div class="row mb-5">
                                    ...
                                    <div class="col-md-12 fv-row">
                                        <!--begin::Label-->
                                        <label class="required fs-5 fw-semibold mb-2">Banner Page Image</label><br>
                                        <!--end::Label-->
                                        @if ($courses->bannerPicture)
                                        <img src="{{ asset('storage/' . ($courses->bannerPicture->path)) }}" height="50" width="50" alt="Course Logo">
                                        @endif
                                        <!--begin::Input-->
                                        <input class="form-control form-control-solid" type="file" placeholder="" value="" name="banner_page" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Col-->
