                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <a type="button" class="btn btn-light-primary me-3" href="{{route('add_pcusers')}}">
                                <i class="ki-duotone ki-plus fs-2"><span class="path1"></span><span class="path2"></span></i> Add New User
                            </a>
                            <!--begin::Menu 1-->
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                <thead>
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">Pending Balance</th>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                ...
                                                <!--end::Menu item-->
                                                 ...
                                                 <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <form action="{{ route('deletepeculiarcontact', ['id' => $contact->id]) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
