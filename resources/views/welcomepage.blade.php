...
<body class="color-theme-blue mont-font">
    ...
    <div class="main-wrap">
        <!-- header wrapper -->
        <div class="header-wrapper pt-3 pb-3 shadow-none pos-fixed position-absolute" style="background-color:#fdc202">
            <div class="container">
                <div class="row">
    ...
    <ul class="navbar-nav nav-menu float-none text-center">
        ...
        <div class="banner-wrapper vh-md-100 layenter emaiquiteer-after app-shape" style="background-color:#fdc202">
            <div class="container">
                <div class="row">
  ...
  <div class="col-12 text-center center-align">
    <!-- Add your "See More" button with Bootstrap classes -->
    <a href="{{route('allcourses')}}" class="btn btn-primary btn-lg fw-500 text-white font-xssss p-2 lh-32 w100 text-center  rounded-xl mt-1">
...
<div class="popular-wrapper pb-0 pt-5">
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-left mb-5 pb-0">
                    <h2 class="text-grey-800 fw-700 display1-size display2-md-size lh-2">Our Team</h2>
                </div>

                <div class="col-lg-12">
                    <div class="feedback-slider owl-carousel owl-theme overflow-visible dot-none right-nav pb-4 nav-xs-none">
                    <div class="owl-items text-center">
    <div class="card w-100 p-4 p-md--5 text-left border-0 shadow-xss rounded-lg">
        <div class="card-body pl-0 pt-0">
            <div class="d-flex align-items-center justify-content-center">
                <img src="{{ asset('media/images/2.jpeg') }}" alt="user" class="w-100 max-width-200 mb-3">
            </div>
            <h4 class="text-grey-900 fw-700 font-xsss mt-0 pt-1">Amos Agboro</h4>
            <h5 class="font-xssss fw-500 mb-1 text-grey-500">Founder</h5>
            <a href="https://www.linkedin.com/in/amos-agboro-35368434/" target="_blank" class="btn btn-primary">Connect on LinkedIn</a>
        </div>
    </div>
</div>
                    <div class="owl-items text-center">
    <div class="card w-100 p-4 p-md--5 text-left border-0 shadow-xss rounded-lg">
        <div class="card-body pl-0 pt-0">
            <div class="d-flex align-items-center justify-content-center">
                <img src="{{ asset('media/images/1.jpeg') }}" alt="user" class="w-100 max-width-200 mb-3">
            </div>
            <h4 class="text-grey-900 fw-700 font-xsss mt-0 pt-1">Yusuf (Olanrewaju) Bello</h4>
            <h5 class="font-xssss fw-500 mb-1 text-grey-500">Cofounder - Head of Faculty</h5>
            <a href="https://www.linkedin.com/in/yusuf-bello-4b7b3967/" target="_blank" class="btn btn-primary">Connect on LinkedIn</a>
        </div>
    </div>
</div>
...
<div class="owl-items text-center">
    <div class="card w-100 p-4 p-md--5 text-left border-0 shadow-xss rounded-lg">
        <div class="card-body pl-0 pt-0">
            <div class="d-flex align-items-center justify-content-center">
                <img src="{{ asset('media/images/3.jpeg') }}" alt="user" class="w-100 max-width-200 mb-3">
            </div>
            <h4 class="text-grey-900 fw-700 font-xsss mt-0 pt-1">Jimi Jeje Jacob</h4>
            <h5 class="font-xssss fw-500 mb-1 text-grey-500">Lead Marketing & Sales</h5>
            <a href="https://www.linkedin.com/in/jimi-jeje-803ab119a/" target="_blank" class="btn btn-primary">Connect on LinkedIn</a>
        </div>
    </div>
</div>
<div class="owl-items text-center">
    <div class="card w-100 p-4 p-md--5 text-left border-0 shadow-xss rounded-lg">
        <div class="card-body pl-0 pt-0">
            <div class="d-flex align-items-center justify-content-center">
                <img src="{{ asset('media/images/4.jpeg') }}" alt="user" class="w-100 max-width-200 mb-3">
            </div>
            <h4 class="text-grey-900 fw-700 font-xsss mt-0 pt-1">Chibueze Ibekwe-Uche</h4>
            <h5 class="font-xssss fw-500 mb-1 text-grey-500">Head of Marketing - Africa & Diaspora</h5>
...
<div class="owl-items text-center">
    <div class="card w-100 p-4 p-md--5 text-left border-0 shadow-xss rounded-lg">
        <div class="card-body pl-0 pt-0">
            <div class="d-flex align-items-center justify-content-center">
                <img src="{{ asset('media/images/5.jpeg') }}" alt="user" class="w-100 max-width-200 mb-3">
            </div>
            <h4 class="text-grey-900 fw-700 font-xsss mt-0 pt-1">Osadiaye Solomon</h4>
            <h5 class="font-xssss fw-500 mb-1 text-grey-500">Co-Founder - Lead Developer</h5>
            <a href="https://www.linkedin.com/in/solomon-osadiaye" target="_blank" class="btn btn-primary">Connect on LinkedIn</a>
        </div>
    </div>
</div>
                    </div>
 ...
 <!-- Initialize Owl Carousel -->
    ...
    $(document).ready(function() {
        $('.feedback-slider').owlCarousel({
            ...
            nav: true,
            navText: ["<i class='fas fa-chevron-left text-black'></i>", "<i class='fas fa-chevron-right text-white'></i>"],
