...
<div class="middle-sidebar-left">
    ...
    <div class="card border-0 mb-0 rounded-lg overflow-hidden live-stream bg-image-center bg-image-cover">
        <div class="card-body d-flex justify-content-start p-2 position-absolute top-0 w-100">
            ...
            <video id="videoPlayer" width="100%" height="400">
...
ChatGPT
To remove the default video controls and add custom controls for forward and speed (1x, 2x, 3x), you can modify the HTML and JavaScript as follows:
...
<div class="col-md-7">
    <div class="card border-0 mb-0 rounded-lg overflow-hidden live-stream bg-image-center bg-image-cover">
        <div class="card-body d-flex justify-content-start p-2 position-absolute top-0 w-100">
            <!-- Video Player with Increased Height -->
            <video id="videoPlayer" width="100%" height="400" preload="metadata">
                <source src="" type="video/mp4">
                Your browser does not support the video tag.
            </video>
            <div class="video-controls">
                ...
                <div class="speed-control">
                    ...
                    <button id="speed1xBtn" class="speed-button">1x</button>
                    <button id="speed2xBtn" class="speed-button">2x</button>
                    <button id="speed3xBtn" class="speed-button">3x</button>
                </div>
                <input id="volumeControl" class="volume-control" type="range" min="0" max="1" step="0.1" value="1">
                <span id="currentTime" class="time-label">0:00</span>
                <progress id="progressBar" class="progress-bar" value="0" max="100"></progress>
...
<style>
    /* Your existing CSS styles for video and controls */
...
This code adds custom video controls for play/pause, forward, and speed (1x, 2x, 3x). You can click the speed buttons to change the playback speed, and the forward button to skip forward by 10 seconds. The default video controls are removed.
