                ...
                <div class="d-flex flex-column flex-xl-row">
                    ...
                    <div class="card bg-body me-xl-12 mb-9 mb-xl-0">
                        <div class="card-body">
                            ...
                            @endif
                            <!--begin::Form-->
                            <form action="{{ route('subtopics.store') }}" class="form mb-15" method="POST" id="kt_careers_form" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col-md-12 fv-row">
                                        ...
                                        <select name="course_subtopic_id" id="course_subtopic_id" class="form-control form-control-solid">
                                            <!-- Options will be populated dynamically using JavaScript -->
