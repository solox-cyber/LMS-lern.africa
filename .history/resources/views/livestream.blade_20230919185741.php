...
<div class="middle-sidebar-left">
    ...
    <span class="ml-auto font-xssss fw-500 text-grey-500 video-duration" id="video-duration-{{ $video->title }}">44</span>
</div>
    ...
    videoTitles.forEach(videoTitle => {
        videoTitle.addEventListener('click', function() {
            ...
            videoPlayer.addEventListener('loadedmetadata', function() {
                ...
                const videoDurationElement = document.querySelector('.video-duration');
                videoDurationElement.textContent = `${minutes}:${seconds}`;
            });
        });
    });
</script>
